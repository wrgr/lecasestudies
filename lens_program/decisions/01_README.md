...
| File | What it is |
| --- | --- |
| `02_len01_clo_mlo_record.md` | LEN 1's course tier: seven CLOs, their LEO and PLO derivation, the module structure, the fifteen case slots, and the reading-sourcing audit |
...
| `07_len01_completeness_and_record_procedure.md` | What LEN 1 still needs, by owner; and the procedure for applying changes to the record |
